...
if len(sys.argv) != 2:
    print("Usage: python tests/plot_results_exp3.py results/exp3")
    raise SystemExit(1)

folder = sys.argv[1]

configs = [
    ("unprotected_aws", "AWS Unprotected"),
    ("protected_aws", "AWS Protected"),
]
...
if plotted_rps:
    ...
    plt.title("AWS Experiment 3 Throughput Comparison")
    plt.legend()
    plt.tight_layout()
...
if plotted_avg:
    ...
    plt.title("AWS Experiment 3 Average Latency Comparison")
    plt.legend()
    plt.tight_layout()
...
if plotted_p95:
    ...
    plt.xlabel("Time")
    plt.ylabel("Milliseconds")
    plt.title("AWS Experiment 3 P95 Latency Comparison")
    plt.legend()
    plt.tight_layout()
