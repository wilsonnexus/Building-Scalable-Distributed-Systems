...
configs = [
    ("small_aws", "Small AWS Load"),
    ("medium_aws", "Medium AWS Load"),
    ("heavy_aws", "Heavy AWS Load"),
]
...
if plotted_rps:
    ...
    plt.title("AWS Experiment 1 Throughput Comparison")
    plt.legend()
    plt.tight_layout()
...
if plotted_avg:
    ...
    plt.title("AWS Experiment 1 Average Latency Comparison")
    plt.legend()
    plt.tight_layout()
...
if plotted_p95:
    ...
    plt.xlabel("Time")
    plt.ylabel("Milliseconds")
    plt.title("AWS Experiment 1 P95 Latency Comparison")
    plt.legend()
    plt.tight_layout()
